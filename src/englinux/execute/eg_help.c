...
void eg_help()
{
    const char *cmds[] = {cmd, help_cmd, exit_cmd, clear_cmd, total_cmd,  author_cmd, find_cmd, NULL};
    const char *descriptions[] = {description, help_description, exit_description, clear_description, total_description, 
