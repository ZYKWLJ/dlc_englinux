...
const char *description = "Command Function";
const char *help_description = "View Command List";
const char *back_description = "Return to Troposphere";
const char *exit_description = "Exit Program";
const char *clear_description = "Clear Screen";
const char *total_description = "Total Words";
const char *author_description = "Author Info";
const char *story_description = "Software Story";
const char *find_description = "Search Words";
void eg_help()
{
