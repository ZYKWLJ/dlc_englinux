...
void text_help()
{
    const char *text_cmds[] = {text_cmd, text_eg_cmd,text_help_cmd, text_exit_cmd,text_time_cmd, text_clear_cmd, text_author_cmd, text_story_cmd, text_list_cmd, text_find_cmd, text_page_cmd, NULL};
    const char *text_descriptions[] = {text_description, text_eg_description,text_help_description, text_exit_description,text_time_description, text_clear_description, text_author_description, text_story_description, text_list_description, text_find_description, text_page_description, NULL};
